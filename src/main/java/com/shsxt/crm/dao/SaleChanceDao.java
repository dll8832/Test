...
import com.shsxt.crm.dao.provider.SelectSql;
...
public interface SaleChanceDao {
	...
	//@Select("select customer_name as customerName,link_man as linkMan from t_sale_chance where is_valid =1")
	
	@SelectProvider(type = SelectSql.class,method="selectForPage")
	public List<SaleChance> selectForPage(SaleChanceQuery saleChanceQuery,PageBounds pageBounds);
	...
	@SelectProvider(type=SelectSql.class,method="findById")
